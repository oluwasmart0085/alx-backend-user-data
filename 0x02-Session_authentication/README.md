...
In the industry, you should  **not**  implement your own Session authentication system and use a module or framework that doing it for you (like in Python-Flask:  [Flask-HTTPAuth](https://intranet.alxswe.com/projects/1241/3Q-d2k3A-L-AyrvAcUJzAg "Flask-HTTPAuth")). Here, for the learning purpose, we will walk through each step of this mechanism to understand it by doing.

## Resources

**Read or watch**:

-   [REST API Authentication Mechanisms - Only the session auth part](https://intranet.alxswe.com/projects/1241/rltoken/iT3ar2nR1Ljhujo5Qyvfpg "REST API Authentication Mechanisms - Only the session auth part")
-   [HTTP Cookie](https://intranet.alxswe.com/projects/1241/rltoken/jvMahr6fVHaCtt-grGFM9A "HTTP Cookie")
-   [Flask](https://intranet.alxswe.com/projects/1241/rltoken/s4vbno-huyUzOrgDXDgj3w "Flask")
-   [Flask Cookie](At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/vhOzZfYPdPi5_6x66CMzfQ "explain to anyone"),  **without the help of Google**:

### General
/rltoken/vhOzZfYPdPi5_6x66CMzfQ "explain to anyone"),  **without the help of Google**:

### General
/rltoken/jk07WKFJylBJmvSuJce_qQ "Flask Cookie")
...
Copy all your work of the  [0x06. Basic authentication](https://intranet.alxswe.com/projects/1241/rltoken/8ruHUp_oXn2XvMDJ0Qeg4A "0x06. Basic authentication")  project in this new folder.
