...
In the industry, you should  **not**  implement your own authentication system and use a module or framework that doing it for you (like in Python-Flask:  [Flask-User](https://intranet.alxswe.com/projects/1242/rltoken/r1XmxzZ-clc7laax6Tm7WQ "Flask-User")). Here, for the learning purpose, we will walk through each step of this mechanism to understand it by doing.

## Resources

**Read or watch:**

-   [Flask documentation](https://intranet.alxswe.com/projects/1242/rltoken/LSFQS3aarknJpMZVr9Je1Q "Flask documentation")
-   [Requests module](https://intranet.alxswe.com/projects/1242/rltoken/PqxwI-hQOe4b4Hhah4fbVg "Requests module")
-   [HTTP status codes](https://intranet.alxswe.com/projects/1242/rltoken/QoqUvOM9taMBOVaeB_g06g "HTTP status codes")

## Learning Objectives

At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.alxswe.com/projects/1242/rltoken/IAeORv21eo25XYJByjx_bg "explain to anyone"),  **without the help of Google**:
...
In this task you will create a SQLAlchemy model named  `User`  for a database table named  `users`  (by using the  [mapping declaration](https://intranet.alxswe.com/projects/1242/rltoken/IF5xw2va364LrJEntCXLlg "mapping declaration")  of SQLAlchemy).
