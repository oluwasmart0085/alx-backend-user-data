...
-   [What Is PII, non-PII, and Personal Data?](https://intranet.alxswe.com/rltoken/mIWE8AiEUxZSuNglSkReHA "What Is PII, non-PII, and Personal Data?")
-   [logging documentation](https://intranet.alxswe.com//rltoken/XeSgXBOYlU7sltsDLMJAoA "logging documentation")
-   [bcrypt package](https://intranet.alxswe.com//rltoken/xBxDUb07T5Am-ewyZhxs9Q "bcrypt package")
-   [Logging to Files, Setting Levels, and Formatting](https://intranet.alxswe.com//rltoken/A60AjUOVVr8ZIXHvpFaeRw "Logging to Files, Setting Levels, and Formatting")

## Learning Objectives

At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.alxswe.com//rltoken/MOxPcg5QTZeXP4GgAp3Q6A "explain to anyone"),  **without the help of Google**:
